 ...
 * Image Field View
 */
class FieldViewFile extends FieldViewString
{
    ...
    /**
     * Método de conveniencia que dados una tabla, campo y valor devuelve la ruta local del fichero.
     * @param $table
     * @param $field
     * @param $value
     * @return void;
    ...
    {
        if (!trueEmpty($value)) {
            return self::genBasePath($table, $field) . \zfx\a(\zfx\FieldViewFile::extractNames($value), 'stored');
        }
        else {
            return '';
        }
    ...
    {
        if (!trueEmpty($value)) {
            return self::genBaseUrl($table, $field) . \zfx\a(\zfx\FieldViewFile::extractNames($value), 'stored');
        }
        else {
            return '';
        }
